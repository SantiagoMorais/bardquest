# 🎨 Paleta de Cores - Medieval/Campos/Aventura

## Browns (Terra)

```
brown-900: #6B5A4A (rgba 107,90,74)   - Escuro
brown-700: #8B7355 (rgba 139,115,85)  - Base
brown-500: #A98B76 (rgba 169,139,118) - Claro
brown-300: #BFA28C (rgba 191,162,140) - Muito claro
```

**Uso:** Textos, elementos, backgrounds quentes

## Beige (Areia)

```
beige-100: #F3E4C9 (rgba 243,228,201) - Off-white
beige-300: #E8D4B0 (rgba 232,212,176) - Médio
beige-500: #D4C4A8 (rgba 212,196,168) - Natural
```

**Uso:** Backgrounds, cards, borders

## Greens (Campos)

```
green-900: #6B8E3F (rgba 107,142,63) - Escuro
green-700: #A8AD7F (rgba 168,173,127) - Natural
green-300: #BABF94 (rgba 186,191,148) - Claro
```

**Uso:** Success, status, elementos naturais

## Blues (Aventura)

```
blue-900: #1E3A8A (rgba 30,58,138)   - Profundo
blue-700: #3856B8 (rgba 56,86,184)   - Aventura
blue-500: #4A77A8 (rgba 74,119,168)  - Céu (destaque)
blue-300: #84A8D0 (rgba 132,168,208) - Claro
```

**Uso:** Links, info, elementos de ação, destaques

## Golds (Ação)

```
gold-900: #5A3F1F (rgba 90,63,31)    - Escuro
gold-700: #A8691F (rgba 168,105,31)  - Base
gold-500: #D4802A (rgba 212,128,42)  - Quente (primário)
gold-300: #E89B3C (rgba 232,155,60)  - Claro
```

**Uso:** Botões, ações primárias, destaque
...
| Elemento           | Cor       | Hover            |
| ------------------ | --------- | ---------------- |
| **Card**           | beige-100 | border: blue-300 |
| **Botão primário** | gold-500  | gold-700         |
| **Link**           | blue-700  | blue-900         |
| **Success**        | green-300 | green-700        |
| **Texto claro**    | brown-900 | -                |
| **Texto médio**    | brown-700 | -                |

---

**Pro Tip:** Use `gold-500` para chamar atenção, `blue-500` para info, `green-300` para success!
...
**Uso:** Elementos principais, backgrounds, borders, texto
...
**Uso:** Backgrounds, cards, borders claros, elementos neutros
...
**Uso:** Status de sucesso, ícones naturais, elementos de campo
...
**Uso:** Links, info, elementos de aventura, ênfase
...
**Uso:** Botões, ações primárias, elementos de destaque

---

## 🌡️ Backgrounds & Text - Light Theme
...
🏰 **Medieval** - Tons quentes, terrosos e confortáveis (marrom, bege)  
🌾 **Campos** - Verde natural que transmite crescimento e harmonia  
⚔️ **Aventura** - Azul que sugere céu aberto, exploração e mistério  
✨ **Destaque** - Dourado quente para ações e elementos importantes

A paleta foi pensada para criar uma experiência visual imersiva, transmitindo aventura responsável em um cenário natural e aconchegante.

---

**Pronto para colorir sua aventura medieval! 🎨**
